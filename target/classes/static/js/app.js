// Eco Guardian Spring Boot JavaScript Application

class EcoGuardianSpringApp {
    constructor() {
    ...
    async init() {
        console.log('Initializing Eco Guardian Spring Boot App...');
        ...
        console.log('Eco Guardian Spring Boot App initialized successfully');
    }
    ...
    updateUserDisplay() {
        ...
        // Update hero stats
        const totalCO2Element = document.getElementById('total-co2-saved');
        const totalPointsElement = document.getElementById('total-points');
        const totalAchievementsElement = document.getElementById('total-achievements');
        
        if (totalCO2Element) totalCO2Element.textContent = this.currentUser.totalCO2Saved;
        if (totalPointsElement) totalPointsElement.textContent = this.currentUser.ecoPoints;
        if (totalAchievementsElement) totalAchievementsElement.textContent = this.currentUser.achievements.length;
    }
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 level-card">
                    <div class="card-body text-center">
                        <div class="spring-ai-badge mb-2">Spring AI Powered</div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ${actions.length > 0 ? 
                            ...
                            `).join('') :
                            '<p class="text-muted">No actions yet. Upload an image to get started with Spring AI analysis!</p>'
                        }
                    </div>
                </div>
            </div>
    ...
    async handleAnalysisSubmit(event) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                this.showToast(`Spring AI Analysis complete! Identified: ${result.analysis.analysis.itemName}`, 'success');
            } else {
                const error = await response.json();
                throw new Error(error.message || 'Spring AI analysis failed');
            }
        } catch (error) {
            console.error('Spring AI analysis error:', error);
            let errorMessage = error.message || 'Failed to analyze image with Spring AI. Please try again.';
            
            if (error.message && error.message.includes('quota')) {
                errorMessage = 'OpenAI API quota exceeded. Using demo data for Spring AI analysis.';
            }
    ...
    displayAnalysisResults(result) {
        ...
        resultsContent.innerHTML = `
            <div class="spring-ai-badge mb-3">Powered by Spring AI + OpenAI GPT-4o</div>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="analysis-confidence">
                        ...
                        <div class="confidence-bar-container">
                            <small class="text-muted">AI Confidence: ${Math.round(analysis.confidence * 100)}%</small>
            ...
            <h5 class="text-success mb-3">Spring AI Generated Eco-Friendly Alternatives</h5>
            <div class="row">
            ...
            <div class="alert alert-success mt-3">
                ...
                <strong>Excellent work!</strong> Spring AI helped you earn <strong>${result.analysis.recommendedPoints} EcoPoints</strong> 
                and save <strong>${result.analysis.totalCO2Savings}kg of CO2</strong> by analyzing this item!
            </div>
        `;
...
// Initialize the Spring Boot application when DOM is loaded
document.addEventListener('DOMContentLoaded', () => {
    window.ecoApp = new EcoGuardianSpringApp();
});