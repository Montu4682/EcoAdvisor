...
<head>
    ...
    <title>Eco Guardian - AI-Powered Waste Reduction & Reusability Advisor</title>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="navbar-text">
                    <span class="badge bg-warning text-dark">
                        ...
                        <span id="user-points">0</span> EcoPoints
                    </span>
                    <span class="badge bg-info ms-2" id="user-level">Loading...</span>
                </div>
            </div>
        </div>
    </nav>
            ...
            <div class="row align-items-center min-vh-50">
                <div class="col-lg-6">
                    <h1 class="display-4 fw-bold mb-4">
                        Transform Your Environmental Impact with AI
                    </h1>
                    <p class="lead mb-4">
                        Upload photos of everyday items and get personalized eco-friendly alternatives. 
                ...
                <div class="col-lg-6 text-center">
                    <div class="hero-stats">
                        <div class="row">
                            <div class="col-4">
                                <div class="stat-item">
                                    <h3 class="h2 fw-bold text-warning" id="total-co2-saved">0</h3>
                                    <p class="mb-0">CO2 Saved (kg)</p>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="stat-item">
                                    <h3 class="h2 fw-bold text-info" id="total-points">0</h3>
                                    <p class="mb-0">EcoPoints</p>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="stat-item">
                                    <h3 class="h2 fw-bold text-light" id="total-achievements">0</h3>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        <h2 class="h1 fw-bold text-success">AI-Powered Item Analysis</h2>
                        <p class="lead text-muted">
                            Upload a photo of any item to get instant eco-friendly alternatives and environmental impact analysis
                        </p>
                    </div>
                    ...
                    <div id="analysis-results" class="d-none mt-5">
                        <div class="card shadow">
                            <div class="card-header bg-success text-white">
                                <h4 class="mb-0"><i class="bi bi-lightbulb me-2"></i>Analysis Results</h4>
                            </div>
                            <div class="card-body">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="mb-0">AI-powered waste reduction and sustainability advisor</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="mb-0">&copy; 2025 Eco Guardian. Making the world more sustainable, one item at a time.</p>
                </div>
            </div>
        </div>
    </footer>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-4">
                    ...
                    <h5>Analyzing your image with AI...</h5>
